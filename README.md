...
```shell
php occ app_api:app:register nc_ws_sign_app <deploy_daemon> --info-xml https://raw.githubusercontent.com/zaosmm/nc_ws_sign_app/refs/heads/master/appinfo/info.xml
```
